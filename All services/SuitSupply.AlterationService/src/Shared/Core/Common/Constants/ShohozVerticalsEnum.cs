// <copyright file="SuitSupplyVerticalsEnum.cs" company="PlaceholderCompany">
// Copyright (c) PlaceholderCompany. All rights reserved.
// </copyright>

namespace SuitSupply.Platform.Infrastructure.Common.Constants
{
    using System.ComponentModel;

    /// <summary>SuitSupply verticals.</summary>
    public enum SuitSupplyVerticalsEnum
    {
