// <copyright file="BusMessageDispatcher.cs" company="SuitSupply">
...
namespace SuitSupply.Platform.Infrastructure.Core.Bus
{
    ...
    /// <seealso cref="SuitSupply.Platform.Infrastructure.Core.Bus.IBusMessageDispatcher" />
    public class BusMessageDispatcher : IBusMessageDispatcher
    {
            ...
            where TMessage : IBusQueueMessage
        {
            ...
            {
                //throw new SuitSupplyBaseException("IBusQueueMessage or command must have CorrelationId");
            }
